...
===================
  ...
  * Add element to success call with CG. Fixes #60
  ...
  * Added US zip code support and CG. Fixes #90
  ...
  * Fixed regex issue for decimals without leading zeroes. Added new methods CG. Fixes #41
