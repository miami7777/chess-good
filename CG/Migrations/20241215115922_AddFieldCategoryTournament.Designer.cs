...
namespace test.Migrations
{
    ...
    [Migration("20241215115922_AddFieldCategoryTournament")]
    partial class AddFieldCategoryTournament
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("test.Domain.Entities.ClockTournament", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CG.Domain.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Avatar = "avatar-3.jpg",
                            ConcurrencyStamp = "3a072813-cf0a-4046-9897-f82fc820aec4",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGHCMqooLNqjJqGSIvm4ObiNQyakHwUfoTdGeGgDJ/8hlvejMTc4wG8f5PrKon1xIA==",
                        ...
                        new
                        {
                            ...
                            Avatar = "avatar-3.jpg",
                            City = "Ставрополь",
                            ConcurrencyStamp = "717c90eb-fea3-4f7c-9e2c-1a817db843bc",
                            Country = "Россия",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEAF/EhcO+lcd1IJfMCgTcbAQcSpcGAk3D0kdHKY3Lh+LVA5rf+uP14L2Bk+kzUi1Ag==",
                            Patronymic = "Владимирович",
                            PhoneNumberConfirmed = false,
                        ...
                        new
                        {
                            ...
                            ChessTitle = 7,
                            City = "Краснодар",
                            ConcurrencyStamp = "a427d9c3-14e1-4c21-810a-7634a12d5997",
                            Country = "Россия",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEAJuzhFP/wGzmAIkdVcWPMmBFy0TJlzEYIChh/oDZ9mP1ew3yZ8nxqV31w3SFuqzvA==",
                        ...
                        new
                        {
                            ...
                            Avatar = "avatar-2.jpg",
                            City = "Ростов-на-Дону",
                            ConcurrencyStamp = "fd53135e-529b-465d-9355-ab5a8ffcd07e",
                            Country = "Россия",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGCGI5Cl6c6MYvIQ4f2YN6ZpzC7MyitJZ8zWgYP9PJbKX+0WFBDeCbxY11DGSxG4mw==",
                        ...
                        new
                        {
                            Id = "5",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a9abb0d2-e690-4368-862f-2dd64e6d43cc",
                            DateBirthday = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "user@user.ru",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGbX1AfJabrlwd6Z7CnJ0aCDNZSmczrgH7TWrW4AHqgNlaMsc+t5wfpITBwc0xt5eg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            Sex = 0,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            City = "Краснодар",
                            ConcurrencyStamp = "6b61dc55-6b2e-439e-ab17-e0ec96b3214b",
                            Country = "Россия",
                            DateBirthday = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAECT1nReRtZWNs+Nnzmdsk5BMWjvIK4AIzI3XvbqBJbjDjYn+FY1VFwA1Svq8w2Uo6w==",
                            PhoneNumberConfirmed = false,
                            Region = "Краснодарский край",
                            SecurityStamp = "",
                            Sex = 0,
                        ...
                        new
                        {
                            Id = "7",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4a8add93-3456-48dc-ae69-7587cd60f90d",
                            DateBirthday = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "student@student.ru",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAELdL1EGDNewfDCShgpwFFwNEtY0iG+Kd8GOwfuz7B3cdLtHmiSCb9ZrjK99K3HvhKA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            Sex = 0,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = "8",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e0f7f4b7-e34e-4746-9769-afce8d12aa87",
                            DateBirthday = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "student@student.ru",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEF3FK0UHHGpygrlkGMFVr8C9TTO8PYEpPwpKYnTdZ0cPitw+O5dzHcQ5rNaqG0i4Ew==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            Sex = 0,
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = "9",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e0bf0da7-1ad4-4137-83ba-6fb16bd88f77",
                            DateBirthday = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "student@student.ru",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEPCHKdF/fOF43bymDOmZF9lla52QrvCfxPnRoKS00/8I7ruCssquHELFiCfOD6odKg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            Sex = 0,
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("CG.Domain.Entities.Chapters", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(3155),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(3175),
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(3186),
            ...
            modelBuilder.Entity("CG.Domain.Entities.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1887),
                            Currency = 0,
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CategoryTournament = 0,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1916),
                            Currency = 0,
            ...
            modelBuilder.Entity("CG.Domain.Entities.DirectoryCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Color = "ffbb2c",
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1388),
                            Description = "",
                            Icon = "book",
                            IsActive = true,
                            ListOrder = 1,
                        ...
                        new
                        {
                            Id = 2,
                            Color = "5578ff",
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1409),
                            Description = "",
                            Icon = "door-open",
                            IsActive = true,
                            ListOrder = 2,
                        ...
                        new
                        {
                            Id = 3,
                            Color = "e80368",
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1422),
                            Description = "",
                            Icon = "medium",
                            IsActive = true,
                            ListOrder = 3,
                        ...
                        new
                        {
                            Id = 4,
                            Color = "e361ff",
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1435),
                            Description = "",
                            Icon = "door-closed",
                            IsActive = true,
                            ListOrder = 4,
                        ...
                        new
                        {
                            Id = 5,
                            Color = "47aeff",
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1447),
                            Description = "",
                            Icon = "shuffle",
                            IsActive = true,
                            ListOrder = 5,
                        ...
                        new
                        {
                            Id = 6,
                            Color = "ffa76e",
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1461),
                            Description = "",
                            Icon = "star",
                            IsActive = true,
                            ListOrder = 6,
                        ...
                        new
                        {
                            Id = 7,
                            Color = "11dbcf",
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1472),
                            Description = "",
                        ...
                        new
                        {
                            Id = 8,
                            Color = "4233ff",
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1484),
                            Description = "",
                            Icon = "stop-circle",
                            IsActive = true,
                            ListOrder = 8,
                        ...
                        new
                        {
                            Id = 9,
                            Color = "b2904f",
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1496),
                            Description = "",
                            Icon = "textarea-t",
                            IsActive = true,
                            ListOrder = 9,
                        ...
                        new
                        {
                            Id = 10,
                            Color = "b20969",
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1508),
                            Description = "",
                            Icon = "people-fill",
                            IsActive = true,
                            ListOrder = 10,
                        ...
                        new
                        {
                            Id = 11,
                            Color = "ff5828",
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1519),
                            Description = "",
                            Icon = "stack",
                            IsActive = true,
                            ListOrder = 11,
                        ...
                        new
                        {
                            Id = 12,
                            Color = "29cc61",
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1587),
                            Description = "",
                            Icon = "list-task",
                            IsActive = true,
                            ListOrder = 12,
            ...
            modelBuilder.Entity("CG.Domain.Entities.DirectoryStatusCourses", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1793),
                            Description = "",
                            ListOrder = 1,
                            Name = "Опубликован"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1809),
                            Description = "",
                            ListOrder = 2,
                            Name = "В разработке"
                        },
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1821),
                            Description = "",
                            ListOrder = 3,
                            Name = "На модерации"
                        },
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1835),
                            Description = "",
                            ListOrder = 4,
                            Name = "Одобрен"
                        },
                        ...
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1848),
                            Description = "",
                            ListOrder = 5,
                            Name = "В продаже"
                        },
                        ...
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1862),
                            Description = "",
                            ListOrder = 6,
                            Name = "В архиве"
                        });
            ...
            modelBuilder.Entity("CG.Domain.Entities.Reviews", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(3244),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(3261),
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(3273),
                            Description = "Занимается онлайн года 4,5 точно. Тренеры Майя Порожняк и Мурат Болотчиев ❤️❤️❤️самые лучшие тренера! Активные, позитивные, интересные!",
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(3286),
                        ...
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(3298),
                        ...
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(3313),
            ...
            modelBuilder.Entity("CG.Domain.Entities.Service", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1991),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(2004),
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(2016),
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(2028),
                            Name = "Доступ к закрытым курсам"
                        },
                        new
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(2040),
                        ...
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(2052),
                        ...
                        {
                            Id = 7,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(2214),
            ...
            modelBuilder.Entity("CG.Domain.Entities.Settings", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(3333),
            ...
            modelBuilder.Entity("CG.Domain.Entities.Tariffs", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(2988),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(3062),
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(3081),
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(3129),
            ...
            modelBuilder.Entity("CG.Domain.Entities.Webinar", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AvailableSeats = 30,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1946),
                            Currency = 0,
                        ...
                        new
                        {
                            ...
                            AvailableSeats = 30,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2024, 12, 15, 11, 59, 21, 913, DateTimeKind.Utc).AddTicks(1968),
                            Currency = 0,
            ...
            modelBuilder.Entity("CG.Domain.Entities.Course", b =>
                {
                    ...
                    b.HasOne("test.Domain.Entities.ClockTournament", "ClockTournament")
                        .WithMany()
